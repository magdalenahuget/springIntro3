...
import com.company.bezkoderonetoone.repository.TutorialDetailsRepository;
...
public class TutorialDetailsController {
    ...
    public ResponseEntity<TutorialDetails> createDetails(
    ...
    public ResponseEntity<TutorialDetails> updateDetails(@PathVariable("id") Long id,
        ...
        return new ResponseEntity<>(detailsRepository.save(detailsRequest), HttpStatus.OK);
    }
